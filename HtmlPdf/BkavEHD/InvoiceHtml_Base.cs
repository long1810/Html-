...
namespace BES
{
    public class InvoiceHtml_Base : HtmlElement
    {
        public InvoiceHtml_Base()
        {
            BackgroundColor = "rgb(158,200,251)";
            BorderColor = "rgb(128,125,239)";
            Title = "<title>Document</title>";
            StartHTML = "<!DOCTYPE html> <html lang='en'> <head> <meta charset='UTF-8'> <meta name='viewport' content='width=device-width, initial-scale=1.0'>";
            EndHTML = "</html>";
        ...
        protected virtual string AddLogo(StringBuilder html, string pathLogo, float height, float width, float opacity)
        {
        ...
        protected virtual string AddSigner(StringBuilder html, string pathLogo, float height, float width, float opacity)
        {
            string folderPath = Path.Combine(Application.StartupPath, "PDFs");
            string folderIMG = folderPath.Replace(@"\bin\Debug\PDFs", "") + @"\IMG\";
        ...
        protected virtual string AddBackgroundImg(StringBuilder html, string pathLogo)
        {
        ...
        public virtual string AddInvoiceHeader2(StringBuilder html, string serial, string invoice)
        ...
        public static string AddSingerItem(StringBuilder html, string background, float height, float width, string signedText, string signedByText, string companyName, string signedDate)
        {
            ...
            html.Append($"    <p  style=\"font-weight: normal;\">({signedByText})</p>");
            html.Append($"    <p>{companyName}</p>");
            html.Append($"    <p  style=\"font-weight: normal;\">Ngày ký: {signedDate}</p>");
            html.Append("</div>");
